...
class MySongAdapter (val mySongList : ArrayList<MySongData>) : RecyclerView.Adapter<MySongAdapter.MySongViewHolder>(){
    ...
    inner class MySongViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        val duet_idx=v.findViewById<TextView>(R.id.rv_my_song_tv_idx_duet)
        val mr_idx=v.findViewById<TextView>(R.id.rv_my_song_tv_mr_idx)
        val thumbnail=v.findViewById<ImageView>(R.id.rv_my_song_iv_thumbnail)
        val badge=v.findViewById<ImageView>(R.id.badge)
        val title=v.findViewById<TextView>(R.id.rv_my_song_tv_title)
        val singer=v.findViewById<TextView>(R.id.rv_my_song_tv_singer)
        val profile=v.findViewById<CircleImageView>(R.id.rv_my_song_iv_profile)
        val nickname=v.findViewById<TextView>(R.id.rv_my_song_tv_nickname)
        val email=v.findViewById<TextView>(R.id.rv_my_song_tv_email)
        val cnt_play=v.findViewById<TextView>(R.id.rv_my_song_tv_count_play)
        val cnt_reply=v.findViewById<TextView>(R.id.rv_my_song_tv_count_reply)
        val cnt_duet=v.findViewById<TextView>(R.id.rv_my_song_tv_count_duet)
        val duet_path=v.findViewById<TextView>(R.id.rv_my_song_tv_duet_path)
        val extract_path=v.findViewById<TextView>(R.id.rv_my_song_tv_extract_path)
        val mr_path=v.findViewById<TextView>(R.id.rv_my_song_tv_mr)
        val duet_date=v.findViewById<TextView>(R.id.rv_my_song_tv_date)
